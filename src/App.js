...
function App() {
    ...
    const [messages, setMessages] = useState([
        {
        text: "Hi, I am ChatGPT, a state-of-the-art language model developed by OpenAi. I am designed to understand and generate human-like text based on the information provided.",
        isBot: true,
        }
    ]);
                    ...
                    <div className="chats">
                        {messages.map((message, i)=>
                            <div key={i} className={message.isBot?"chat bot":"chat"}>
                                <img className="chatImg" src={message.isBot?gptImgLogo:userIcon} alt=""/><p className="txt">{messages.text}</p>
                            </div>
                        )}
                        <div ref={msgEnd}/>
                    </div>
